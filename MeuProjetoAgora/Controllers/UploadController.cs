...
namespace MeuProjetoAgora.Controllers
{
    public class UploadController : Controller
    {
            ...
            [FromServices] IHostingEnvironment hostingEnvironment)
        {
            ...
            filename = this.EnsureCorrectFilename(filename, video.IdElemento);
            ...
            return $"Chave do elemento: {video.IdElemento}";
        }
            ...
            [FromServices] IHostingEnvironment hostingEnvironment)
        {
            ...
            filename = this.EnsureCorrectFilename(filename, pag.IdPagina);
            ...
            [FromServices] IHostingEnvironment hostingEnvironment)
        {
            var local = await db.PastaImagem
                .Include(p => p.Imagens)
                .FirstAsync(p => p.IdPastaImagem == int.Parse(pasta));
            ...
            foreach (IFormFile source in files)
            {
                ...
                filename = this.EnsureCorrectFilename(filename, img.IdElemento);

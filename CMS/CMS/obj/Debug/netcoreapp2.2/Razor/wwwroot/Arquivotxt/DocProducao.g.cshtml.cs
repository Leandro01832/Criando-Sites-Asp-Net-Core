#pragma checksum "D:\cms-clean\CMS\CMS\wwwroot\Arquivotxt\DocProducao.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "7765bf05940047c72312dc06bd1583c85d678fe2"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"7765bf05940047c72312dc06bd1583c85d678fe2", @"/wwwroot/Arquivotxt/DocProducao.cshtml")]
    public class wwwroot_Arquivotxt_DocProducao : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        #pragma warning disable 1998
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            BeginContext(0, 26097, true);
...
<div id='conteudo$model.Pagina.Id' class='Conteudo'>
    ...
    <div id='corpo' data-value='$model.Div1.DivId' class='Corpo'>

    </div>

    #if($model.Pagina.Topo)
    <div id='$model.Div2.DivId' class='Topo' data-value='$model.Div2.DivId'>
        <h1>$model.titulo</h1>
    </div>
    #end

    #if($model.Pagina.Menu)
    <div id='$model.Div3.DivId' class='Menu' data-value='$model.Div3.DivId'>
        <p>menu</p>
        <br />
        ...
        #if ($model.instagram != ");
            WriteLiteral(@"'vazio' && $model.instagram != '')
    ...
    <div id='blocos$model.Div4.DivId' class='bloco' data-value='$model.Div4.DivId'>
        ...
        <div class='row linha' id='line$nunber'>
            ...
            #if ($bloco.Div.Divisao == 'col-md-6' && $bloco.Div.Desenhado == 0 || $bloco.Div.Divisao == 'col-");
            WriteLiteral(@"sm-6' && $bloco.Div.Desenhado == 0)
            ...
            <div id='DIV${bloco.Div.Id}Pagina${model.Pagina.Id}' class='ClassDiv $bloco.Div.Divisao grid-con");
            WriteLiteral(@"tainer' data-value='$bloco.Div.Id'>



                #foreach($element in $bloco.Div.Elemento)

                #if($element.Elemento.Tipo != 'LinkBody' && $element.Elemento.Tipo != 'Dropdown')
                    ...
                    <div id='element${element.Elemento.Id}Pagina${model.Pagina.Id}' class='Elemento$element.Elemento.Id grid-item' data-value='$element.Elemento.Id' data-id='$element.Elemento.Id'>
                            ...
                            <div id='carouselsite$element.Elemento.Id' class='carousel' data-ride='carousel'>
                                <div class='carousel-inner' role='listbox'>
                                    ...
                                    <div class='item'>
                                        <img class='img-responsive minha");
            WriteLiteral(@"img' src='$site$dependente.ElementoDependente.Dependente.ArquivoImagem' alt='imagem' style='width:${dependente.ElementoDependente.Dependente.Width}%;' />
            ...
            WriteLiteral(@"kIndice == 0)
                                                ...
                                                <div id='LinkCarouselPagina${el.Elemento.Id}Pagina${model.Pagina.Id}' class='grid-item'>
      ");
            WriteLiteral(@"                                              <a href='$el.Elemento.TextoLink'>
            ...
            WriteLiteral(@"                    </a>
                                                ...
                                                <div id='FormCarouselPagina${el.Elemento.Id}Pagina${model.Pagina.Id}' class='grid-item'>
                                                    ...
                                                    <form>
                         ");
            WriteLiteral(@"                               #foreach($el in $el.Elemento.Despendentes)
            ...
            WriteLiteral(@"                     $(document).ready(function () {
                                                        ...
                                                        $('#SalvarDadosFormulario').click(function () {
                                                            ...
                                                            for (var i = 0; i !== Arquivos.length; i++) {
                                                                ...
                                                                formData.append('Formu");
            WriteLiteral(@"lario', $el.Elemento.Id);
                                                            }
            ...
            WriteLiteral(@"                                           });
                            ...
                            <form>
                                ...
                                <label>$el.ElementoDependente.Dependente.Nome</label>
                                <input class='CampoFormulario$element.Elemento.Id' id='Campo$el.ElementoDependente.Dependente.Id' name='Campo");
            WriteLiteral(@"$el.ElementoDependente.Dependente.Id' type='$el.ElementoDependente.Dependente.TipoCampo' placeholder='$el.ElementoDependente.Dependente.Placeholder' />
                                <br />
  ...
  ");
            ...
            WriteLiteral(@"            </script>
                        ...
                        <img class='img-responsive' src='$site$element.Elemento.ArquivoImagem' alt='imagem' style='width:${element.Elemento.Width}%;' />
                            ...
                            <a href='/site/$element.Elemento.Destino.Pedido.DominioTemporario/$element.Elemento.Destino.Titulo.Replace(' ', ' ')'>
                                ...
                                #if($linkIndice == 1)
                               ");
            WriteLiteral(@" <img class='img-responsive' src='$site$el.ElementoDependente.Dependente.ArquivoImagem' alt='imagem' style='width:100%;' />
                                #end
                      ...
                      ");
            WriteLiteral(@"          #set($linkIndice = $linkIndice + 1)
            ...
            WriteLiteral(@"    <th>
                                    ...
                                    <th>
                                        <div id='LinksTabela'>
                                            <a href='#' data-value='$prod.ElementoDependente.Dependente.Id' class='btn btn-danger botaoDetalhesProduto'");
            ...
            WriteLiteral(@"        </tr>
                ...
                #elseif($element.Elemento.Tipo == 'LinkBody' && $elemen)
                #if($element.Elemento.UrlLink == false)
                <div id='element${element.Elemento.Id}Pagina${model.Pagina.Id}' class='Elemento$element.Elemento.Id grid-item' data-value='$element.Elemento.Id' data-id='$element.Elemento.Id'>
                    <a href='/site/$ele");
            WriteLiteral(@"ment.Elemento.Destino.Pedido.DominioTemporario/$element.Elemento.Pagina.Titulo.Replace(' ', '')'>
...
<div id='bordaEsquerda$model.Div5.DivId' class='bordaEsquerda' data-value='$model.Div5.DivId'>

");
            WriteLiteral(@"</div>

<div id='bordaDireita$model.Div6.DivId' class='bordaDireita' data-value='$model.Div6.DivId'>

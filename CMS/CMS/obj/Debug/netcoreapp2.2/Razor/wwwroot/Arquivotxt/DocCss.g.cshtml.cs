#pragma checksum "C:\Users\leand\Documents\cms-aspnetcore\copia\CMS\wwwroot\Arquivotxt\DocCss.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "0f73743c5846409e32686f1c315274969e282626"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"0f73743c5846409e32686f1c315274969e282626", @"/wwwroot/Arquivotxt/DocCss.cshtml")]
    public class wwwroot_Arquivotxt_DocCss : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        #pragma warning disable 1998
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            BeginContext(0, 17401, true);
...
<style>
    #menu$model.Div3.Div.Background.Id {
         ...
         #if($um == 1)
        #set($back = $Cores.HexToColor($Cores.CorBac");
...
<style>
    #bordaEsquerda$model.background_borda_esquerda.Id {
        ...
        background-repeat: $model.Div5");
            WriteLiteral(@".Div.Background.Background_Repeat;
    }
</style>
...
<style>
    #bordaEsquerda$model.Div5.Div.Background.Id {
        ...
        background: -webkit-linear-gradient(${");
            WriteLiteral(@"model.Div5.Div.Background.Grau}deg,
        #foreach($Cor in $model.Div5.Div.Background.Cores)
        #set($Transparencia = $Cor.Transparencia / 10)
        rgba($Cor.HexToColor($Cor.CorBackground),$Transparencia.toString().replace(',','.')) ${Cor.Position}%
...
<style>
    #bordaEsquerda$model.Div5.D");
            WriteLiteral(@"iv.Background.Id {
...
<style>
    #blocos$model.Div4.Div.Id {
        ...
        #set($back = $Cores.HexToColor($Cores.CorBackground))
 ");
            WriteLiteral(@"       background: rgb($back); 
        #end
        #set($um = $um + 1)        
         #end
        ...
        background: l");
            WriteLiteral(@"inear-gradient(${model.Div4.Div.Grau}deg,
        #foreach($Cor in $model.Div4.Div.Cores)
        #set($Transparencia = $Cor.Transparencia / 10)
        rgba($Cor.HexToColor($Cor.CorBackground),$Transparencia.toString().replace(',','.')) ${Cor.Position}%
...
<meta charset='UTF-8'>
 ...
 <div id='corpo' data-value='$model.Div1.Div.Id' class='Corpo'>
    ...
    <div id='topo$model.Div2.Div.Id' class='Topo' data-value='$model.Div2.Div.Id'>
        <h1>$model.titulo</h1>
    </div>
    #end

    #if($model.Pagina.Menu)
    <div id='menu$model.Div3.Div.Id' class='Me");
            WriteLiteral(@"nu' data-value='$model.Div3.Div.Id'>
        <p>menu</p>
        <br />
